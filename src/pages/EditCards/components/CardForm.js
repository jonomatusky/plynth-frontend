...
const CardForm = ({ card, onSubmit, pending, onRemove }) => {
  ...
  if (card.type === 'ar') {
    return <ArForm card={card} onSubmit={onSubmit} />
  } else {
    return (
                ...
                {showField.title && (
                  <Grid item xs={12}>
                    <TextField
                      ...
                      name="title"
                      label={
                        showField.title === true ? 'Title' : showField.title
                      }
                ...
                {user.tier && user.tier !== 'free' && showField.textAlign && (
                  <Grid item xs={12} container alignItems="center">
                    ...
                    <Grid item>
                      <IconButton
                        color={
                          card.textAlign === 'right' ? 'primary' : 'default'
                        }
                  ...
                  <>
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        error={
                          formik.touched.spotify &&
                          Boolean(formik.errors.spotify)
                        }
                        helperText={
